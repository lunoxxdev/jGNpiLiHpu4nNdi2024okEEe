...
echo -e "     Jangan Pilih Puan di 2024 !!!!"
echo -e "     Gasuka??? Disconect Aja Bosss"
echo -e "       © Recode By Lunoxx ${YELLOW}(${NC} 2023 ${YELLOW})${NC}"
echo -e "${YELLOW}----------------------------------------------------------${NC}"
echo ""
...
VALIDITY () {
    ...
    Exp1=$(curl https://raw.githubusercontent.com/lunoxxdev/d4l4nW3dUs/main/ip | grep $MYIP | awk '{print $3}')
    if [[ $today < $Exp1 ]]; then
...
IZIN=$(curl https://raw.githubusercontent.com/lunoxxdev/d4l4nW3dUs/main/ip | awk '{print $4}' | grep $MYIP)
if [ $MYIP = $IZIN ]; then
...
echo -e "             ${green}Telegram @lunoxx.impostor"
echo -e "             Lu Semua Kentottttttt"
echo -e "${YELLOW}━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━${NC}"
echo ""
rm -f premi.sh
exit 0
...
# USERNAME
rm -f /usr/bin/user
username=$(curl https://raw.githubusercontent.com/lunoxxdev/d4l4nW3dUs/main/ip | grep $MYIP | awk '{print $2}')
echo "$username" >/usr/bin/user
# validity
rm -f /usr/bin/e
valid=$(curl https://raw.githubusercontent.com/lunoxxdev/d4l4nW3dUs/main/ip | grep $MYIP | awk '{print $3}')
...
BVPN="https://abc.xcodehoster.com/"
# // Installing UDP Mini
mkdir -p /usr/local/kyt/
wget -q -O /usr/local/kyt/udp-mini "${BVPN}badvpn/udp-mini"
chmod +x /usr/local/kyt/udp-mini
wget -q -O /etc/systemd/system/udp-mini-1.service "${BVPN}badvpn/udp-mini-1.service"
wget -q -O /etc/systemd/system/udp-mini-2.service "${BVPN}badvpn/udp-mini-2.service"
wget -q -O /etc/systemd/system/udp-mini-3.service "${BVPN}badvpn/udp-mini-3.service"
